...
results.array.cumulative = generate.cumulative.events.results.array(ncd.simset,
                                                                    years=as.character(c(2023:2040)), # cumulative results only for 2023-2040
                                                                    n.reps=100) 
results.array.annual = generate.annual.events.results.array(ncd.simset,
                                                            years=as.character(c(2014:2040)), # years are 2014-2040
                                                            n.reps=100) 
...
df.hiv.inc = reshape2::melt(cumulative.hiv.inc)
...
plot.cumulative.outcome.boxplot(ncd.simset[[1]],ncd.simset[[2]],ncd.simset[[3]],ncd.simset[[4]],ncd.simset[[5]],
                                data.types=c("n.hiv.inc"),dimension="total") 
dev.off()
...
df.cvd.inc = reshape2::melt(cumulative.cvd.inc)

jpeg(file=paste0("plots/for_paper/Fig3D.jpeg"), width = 1000,height = 500,res=200)
plot.cumulative.outcome.boxplot(ncd.simset[[1]],ncd.simset[[2]],ncd.simset[[3]],ncd.simset[[4]],ncd.simset[[5]],
                                data.types=c("n.cvd.events"),dimension="total") 
dev.off()
...
df.hiv.deaths = reshape2::melt(cumulative.hiv.deaths)

jpeg(file=paste0("plots/for_paper/Fig3E.jpeg"), width = 1000,height = 500,res=200)
plot.cumulative.outcome.boxplot(ncd.simset[[1]],ncd.simset[[2]],ncd.simset[[3]],ncd.simset[[4]],ncd.simset[[5]],
                                data.types=c("n.deaths.hiv"),dimension="total") 
dev.off()
...
df.cvd.deaths = reshape2::melt(cumulative.cvd.deaths)

jpeg(file=paste0("plots/for_paper/Fig3F.jpeg"), width = 1000,height = 500,res=200)
plot.cumulative.outcome.boxplot(ncd.simset[[1]],ncd.simset[[2]],ncd.simset[[3]],ncd.simset[[4]],ncd.simset[[5]],
                                data.types=c("n.deaths.cvd"),dimension="total") 
dev.off()
...
if(1==2){
  ...
  # ggplot(df.coverage, aes(fill=intervention, y=value, x=year)) + 
  #   geom_bar(position="dodge", stat="identity")
  
  # jpeg(file=paste0("plots/for_paper/Fig3C.1.jpeg"), width = 1000,height = 500,res=200)
  # ggplot(df.hiv.inc, aes(x=intervention,y=value, fill=intervention)) + geom_bar(stat="identity")
  # dev.off()
  
  # jpeg(file=paste0("plots/for_paper/Fig3D.1.jpeg"), width = 1000,height = 500,res=200)
  # ggplot(df.cvd.inc, aes(x=intervention,y=value, fill=intervention)) + geom_bar(stat="identity") 
  # dev.off()
  
  # jpeg(file=paste0("plots/for_paper/Fig3E.1.jpeg"), width = 1000,height = 500,res=200)
  # ggplot(df.hiv.deaths, aes(x=intervention,y=value, fill=intervention)) + geom_bar(stat="identity")
  # dev.off()
  
  # jpeg(file=paste0("plots/for_paper/Fig3F.1.jpeg"), width = 1000,height = 500,res=200)
  # ggplot(df.cvd.deaths, aes(x=intervention,y=value, fill=intervention)) + geom_bar(stat="identity")
  # dev.off()
